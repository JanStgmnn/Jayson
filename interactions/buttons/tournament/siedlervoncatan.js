...
module.exports = {
	...
	async execute(interaction) {
		...
		data.games.siedlervoncatan = !data.games.siedlervoncatan;
		if (data.games.siedlervoncatan) {
			data.gamelist.push("siedlervoncatan");
		} else {
			data.gamelist.splice(data.gamelist.indexOf("siedlervoncatan"), 1);
		}
		data.save();
