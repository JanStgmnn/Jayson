...
module.exports = {
	...
	async execute(interaction) {
		...
		data.games.ultimatechickenhorse = !data.games.ultimatechickenhorse;
		if (data.games.ultimatechickenhorse) {
			data.gamelist.push("ultimatechickenhorse");
		} else {
			data.gamelist.splice(data.gamelist.indexOf("ultimatechickenhorse"), 1);
		}
		data.save();
