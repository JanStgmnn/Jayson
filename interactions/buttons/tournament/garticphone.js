...
module.exports = {
	...
	async execute(interaction) {
		...
		data.games.garticphone = !data.games.garticphone;
		if (data.games.garticphone) {
			data.gamelist.push("garticphone");
		} else {
			data.gamelist.splice(data.gamelist.indexOf("garticphone"), 1);
		}
		data.save();
