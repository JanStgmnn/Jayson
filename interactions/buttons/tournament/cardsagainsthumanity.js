...
module.exports = {
	...
	async execute(interaction) {
		...
		data.games.cardsagainsthumanity = !data.games.cardsagainsthumanity;

		if (data.games.cardsagainsthumanity) {
			data.gamelist.push("cardsagainsthumanity");
		} else {
			data.gamelist.splice(data.gamelist.indexOf("cardsagainsthumanity"), 1);
		}
