...
module.exports = {
	...
	async execute(interaction) {
		...
		data.games.secrethitler = !data.games.secrethitler;
		if (data.games.secrethitler) {
			data.gamelist.push("secrethitler");
		} else {
			data.gamelist.splice(data.gamelist.indexOf("secrethitler"), 1);
		}
		data.save();
