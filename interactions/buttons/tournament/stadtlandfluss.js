...
module.exports = {
	...
	async execute(interaction) {
		...
		data.games.stadtlandfluss = !data.games.stadtlandfluss;
		if (data.games.stadtlandfluss) {
			data.gamelist.push("stadtlandfluss");
		} else {
			data.gamelist.splice(data.gamelist.indexOf("stadtlandfluss"), 1);
		}
		data.save();
