...
module.exports = {
	...
	async execute(interaction) {
		...
		new Schema({
			...
			Type: "Discord",
			CategoryID: "1101996726275022888",
			PaymentType: "None",
			Amount: 0,
			Approval: false,
			Status: "Open",
		...
		const replyEmbed = new EmbedBuilder()
			...
			.setDescription(
				"Hello <@!" +
					interaction.user.id +
					">\nI will be with you shortly. In the meantime, please describe which features your Desktop Application should include, your deadline and other useful information!\n\nIncase you want to close the ticket, please  use the button down below!"
			)
			.setColor(2292922)
			.setFooter({
