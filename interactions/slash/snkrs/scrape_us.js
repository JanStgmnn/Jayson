...
module.exports = {
	...
	data: new SlashCommandBuilder()
		.setName("scrape_us")
		.setDescription("Scrapes US SNKRS stock.")
	...
	async execute(interaction) {
		...
		const nike_us_api =
			"https://api.nike.com/product_feed/threads/v3/?anchor=0&count=50&filter=marketplace%28US%29&filter=language%28en%29&filter=upcoming%28true%29&filter=channelId%28010794e5-35fe-4e32-aaff-cd2c74f89d61%29&filter=exclusiveAccess%28true%2Cfalse%29&sort=effectiveStartSellDateAsc";
		...
		const response = await fetch(nike_us_api, { headers });
		...
		for (let i = 0; i < num_of_releases; i++) {
			...
			if (release.productInfo[0].merchProduct.styleColor === request_sku) {
				...
				const product_url =
					"https://www.nike.com/launch/t/" +
					release.publishedContent.properties.seo.slug;
		...
		const embed = new EmbedBuilder()
			...
			.setURL(fin_release.product_url)
			...
			.addFields(
				...
				},
				{
					name: "Links",
					value:
						"[SNKRS App](https://dreamtech.app/monitors/quicktask/snkrs?input=" +
						request_sku +
						") | [SNKRS Web](" +
						fin_release.product_url +
						")",
					inline: false,
				},
				{
